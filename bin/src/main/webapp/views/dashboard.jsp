	...
	<div id="wrapper">
		...
		<ul
			...
			<a
				...
				<div class="sidebar-brand-text mx-3">G3 - MOVIE THEATER</div>
			</a>
			...
			<li class="nav-item"><a id="employee" class="nav-link collapsed">
					...
					class="fas fa-percent"></i> <span>Promotion</span>
			</a></li>
				...
				<nav
					...
					<div
						...
						<div class="input-group">
							<h4 style="color: #D06224;">Admin Dashboard for Movie
								Theater</h4>
						</div>
					</div>
