		...
		<div id="wrapper">
			...
			<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
				...
				<a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin/dashboard">
					...
					<div class="sidebar-brand-text mx-3">MOVIE THEATER</div>
				</a>
				...
				<li class="nav-item"><a class="nav-link collapsed" id="ticket_selling" href="#"> <i
							class="fab fa-cc-amazon-pay"></i>
						<span>Ticket Selling Management</span>
					</a> <a id="employee" class="nav-link collapsed"> <i class="fas fa-users"></i>
						<span>Employee Management</span>
					</a> <a class="nav-link collapsed" href="#" id="movie"> <i class="fas fa-film"></i>
						<span>Movie Management</span>
					</a> <a class="nav-link collapsed" href="#" id="cinema_room"> <i class="fas fa-dungeon"></i>
						<span>Cinema Room</span>
					</a> <a class="nav-link collapsed" href="#" id="promotion"> <i class="fas fa-percent"></i>
				...
				<div id="content">
					...
					<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
						...
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item dropdown no-arrow"><a class="nav-link dropdown-toggle" href="#"
									...
									aria-expanded="false"> <span class="mr-2 d-none d-lg-inline text-gray-600 small"><i
											class="fas fa-caret-down mr-3"></i>${accountLogin.userName}</span>
									<img class="img-profile rounded-circle"
										src="/resources/img/employee/${accountLogin.image}">
					...
					<div class="container-fluid" id="content-page">
						<div class="row justify-content-center">
							<h1 class=" mt-2 text-danger">${message}</h1>
						</div>

						<div class="row justify-content-center">
							<img src="/resources/img/403.jpg" alt="">
						</div>
					</div>
					<!-- /.container-fluid -->
				...
				<footer class="sticky-footer bg-white">
					<div class="container my-auto">
						<div class="copyright text-center my-auto">
							<h6 style="color: #D06224;">G3 &copy; MOVIE THEATER 2021</h6>
						</div>
					</div>
				</footer>
				<!-- End of Footer -->
