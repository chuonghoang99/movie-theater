...
<h3 class="row justify-content-center font-weight-bold">Employee
	List</h3>
<div class="mt-2 mr-4">
	<hr>
	...
	<div class="row mt-1">
		<div class="form-input ml-3">
			<button type="button" class="btn btnCustom" id="addEmployee">
	...
	<div class="row">
		...
		<div class="col-lg-1">
			<div>
				<span class="ml-1">Show</span> <select id="selectPageSize" class="form-control">
		...
		<div class="col-lg-3">
			<div class="row">
				...
				<div class="input-group rounded mr-3">
					<input
							id="inputSearch" type="search" class="form-control rounded"
							placeholder="Search"
					/>
				</div>
			</div>
	...
	<div class="card mt-3" id="content-table">
		...
		<!-- Modal -->
		<div
				class="modal fade" id="modalDeleteEmployee" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title text-danger" id="exampleModalLongTitle">Delete Employee</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<div class="modal-body">
						<h5>Are you sure you want to delete employee: <span id="bindEmpName" class="text-danger"></span>
						</h5>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btnCustom" data-dismiss="modal">Cancle</button>
						<button
								type="button" class="btnCustom" id="cfDeleteEmployee" data-columnDelete=""
								data-employeeId=""
						>Delete
						</button>
					</div>
