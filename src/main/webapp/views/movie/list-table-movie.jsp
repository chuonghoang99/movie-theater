		...
		<tbody>
			<c:forEach items="${movies}" var="movie" varStatus="loop">
				<tr id="movie${movie.movieId}">
					...
					<td><a href="#" id="editMovie" value="${movie.movieId}"><i class="fas fa-edit textBlack"></i></a>
					</td>
					<td><a href="#" id="deleteMovie" value="${movie.movieId}"><i class="fas fa-trash-alt textBlack"></i></a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
...
<!-- Modal -->
<div
		class="modal fade" id="modalDeleteMovie" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
		aria-hidden="true"
>
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" id="cfDeleteMovie" data-columnDelete="" data-movieId="">
					Delete
				</button>
			</div>
		</div>
